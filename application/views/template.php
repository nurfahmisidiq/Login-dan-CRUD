...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Consina Official</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?=base_url()?>/assets/images/consina.jpg" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Consina</div>
                    <div class="email">consina-adventure.com</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?= base_url('index.php/profil/sidiq')?>">

                        <span>Profil</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('index.php/keluarga/familly')?>">

                        <span>Gallery</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('index.php/dreams/nomor')?>">

                        <span>Call Center</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('index.php/hobi/event')?>">

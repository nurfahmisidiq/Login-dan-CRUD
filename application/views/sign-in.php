...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>Consina Official</b></a>
            <small>Consina Indonesia</small>
        </div>
        <div class="card">
            <div class="body">
                <form action="<?=base_url()?>index.php/login/proses_login" id="sign_in" method="POST">
                    <div class="msg">Silahkan login untuk menuju halaman admin consina official</div>
